...
14.2 (reproducible artifact and release documentation), and 14.3 (live
pinned-host verification) are complete and tasks
14.4-14.5 remain; the release tag `v1.1.0` is created only
...
| 14 | v1.1 release | In progress (Phase 14 tasks 14.1, 14.2, and 14.3 complete; tasks 14.4-14.5 pending) | The plugin builds and packages reproducibly at `1.1.0.0`; the full suite and the live pinned-host matrix pass; a fresh security review covers logging, SEC-5, and the settings save path; the changelog/manifest are updated and the annotated `v1.1.0` tag is created after the release-reviewer gate. |
