...
| `eventType` | Metadata changed, artwork requested, artwork rendered, item removed, configuration changed, or cache invalidated | Yes | Generated | Canonical event vocabulary; external event names are mapped into it. |
...
| Canonical field | Jellyfin | Sonarr | Radarr | Mapping |
| --- | --- | --- | --- | --- |
| `status` | Original response eligibility/result | Not applicable | Not applicable | Generated from render/pass-through outcome. |
...
| `passThroughReason` | Request/result constraints | Provider unavailable may contribute | Provider unavailable may contribute | Generated safe reason. |
