...
- **Promoted to v1.1 (ADR-016):** runtime configuration replacement wiring.
  ...
  without a restart. Task 9.4 adds the bounded, non-blocking post-save
  ...
  scheduled run. The final Goal A verification (task 9.5) remains.
