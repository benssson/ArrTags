...
- **Promoted to v1.1 (ADR-016):** runtime configuration replacement wiring.
  ...
  without a restart. The bounded post-save re-render trigger (task 9.4) and the
  final Goal A verification (task 9.5) remain.
